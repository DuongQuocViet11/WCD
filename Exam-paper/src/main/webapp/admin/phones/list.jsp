...
<%
    ...
    List<Brand> listB = (List<Brand>)request.getAttribute("listBrand");
    if (listB==null){
        listB = new ArrayList<>();
    }
%>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/products/detail?id=<%=phone.getId()%>"><i class="mdi mdi-glasses size-big"></i></a>
                                            <a href="/admin/products/delete?id=<%=phone.getId()%>" onclick="return confirm('Are you sure?')"><i class="mdi mdi-delete size-big"></i></a>
...
<!-- container-scroller -->
<jsp:include page="/admin/includes/scripts.jsp"></jsp:include></body>
</html>